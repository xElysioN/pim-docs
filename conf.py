# -*- coding: utf-8 -*-
#
# Akeneo PIM documentation build configuration file, created by
# sphinx-quickstart on Fri Aug 23 23:47:57 2013.
#
...
htmlhelp_basename = 'AkeneoPIMdoc'
...
latex_documents = [
  ('index', 'AkeneoPIM.tex', u'Akeneo PIM Documentation',
   u'Nicolas Dupont', 'manual'),
]
...
man_pages = [
    ('index', 'akeneopim', u'Akeneo PIM Documentation',
     [u'Nicolas Dupont'], 1)
]
...
texinfo_documents = [
  ('index', 'AkeneoPIM', u'Akeneo PIM Documentation',
   u'Nicolas Dupont', 'AkeneoPIM', 'One line description of project.',
   'Miscellaneous'),
]
